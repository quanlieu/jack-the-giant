...
class GameData: NSObject, NSCoding {
    ...
    var easyDifficultyScore: Int32 = 0
    var mediumDifficultyScore: Int32 = 0
    var hardDifficultyScore: Int32 = 0
    
    var easyDifficultyCoinScore: Int32 = 0
    var mediumDifficultyCoinScore: Int32 = 0
    var hardDifficultyCoinScore: Int32 = 0
    
    var easyDifficulty = false
    var mediumDifficulty = true
